...
1. Explain how to build stateful class components.
    ...
    First you declare your class for the component, followed by your constructor and passing in whatever state you want to use, next comes the render.  This way anytime the state is changed, the render updates.

2. Describe the different phases of the component lifecycle.

    Mounting - the component is being built out.  Initial data will be defined in the constructor of this phase.

    Updating - this is when your updating component data. 

    Un-mounting - this is removing the component from the screen.

3. Demonstrate an understanding of class component lifecycle methods.

    The biggest advantage of using class components over regular functions is that we are able to use React methods and hooks that allow us to update the UI and state.
    
4. Define stateful logic.

    Stateful logic is the understanding that data that is used in the webpage is held in state and whenever that state changes, the webpage or app needs to re-render.

5. Describe how to test a React component with React Testing Library.

    In a test file, you create tests that test the functionality of the webpage or app.  For every input value, you give it a test value, execute the test value, and then confirm that what you submitted was the value returned.  We also test the buttons to test that when they are executed, they work correctly and that none of our values have changed.
